...
def bacon_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 10
    if_roll_0 = free_bacon(opponent_score)
    if if_roll_0 >= cutoff :
        return 0
    else:
        return num_rolls
...
def extra_turn_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    if_roll_0 = free_bacon(opponent_score)
    if extra_turn(score + if_roll_0, opponent_score):
        return 0
    else:
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    trials = 1000
    dice = six_sided
    roll = max_scoring_num_rolls(dice, trials)
    f = make_averaged(roll_dice, trials)
    cutoff = int(f(roll, dice))
    if_roll_0 = free_bacon(opponent_score)
    if extra_turn(score + if_roll_0, opponent_score):
        return 0
    else:
        return bacon_strategy(score, opponent_score,cutoff+1, roll)
    # END PROBLEM 12
